...
import 'add_vehicle_page_model.dart';
export 'add_vehicle_page_model.dart';

class AddVehiclePageWidget extends StatefulWidget {
  const AddVehiclePageWidget({super.key});

  static String routeName = 'AddVehiclePage';
  static String routePath = '/addVehiclePage';

  @override
  State<AddVehiclePageWidget> createState() => _AddVehiclePageWidgetState();
}

class _AddVehiclePageWidgetState extends State<AddVehiclePageWidget> {
  late AddVehiclePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddVehiclePageModel());
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              FlutterFlowDropDown<String>(
                                ...
                                onChanged: (val) =>
                                    safeSetState(() => _model.makeValue = val),
                              ...
                              FlutterFlowDropDown<String>(
                                controller: _model.gasTypeValueController ??=
                                    FormFieldController<String>(null),
                    ...
                    onPressed: () async {
                      ...
                      await showDialog(
                        ...
                        builder: (alertDialogContext) {
                          return AlertDialog(
                            title: Text('Success'),
                            content: Text('This vehicle has been added.'),
                            actions: [
                              TextButton(
                                onPressed: () =>
